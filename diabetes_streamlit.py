...
# Fungsi untuk menampilkan halaman prediksi
    ...
    if 'model' not in st.session_state or 'scaler' not in st.session_state:
        ...
        with col1:
            umur = st.slider("Umur:", min_value=10, max_value=70, value=10, step=1)
        ...
        with col2:
            tekanan_darah = st.slider("Tekanan Darah (mmHg):", min_value=80, max_value=200, value=80, step=1)
            bmi = st.slider("BMI:", min_value=10.0, max_value=50.0, value=10.0, step=0.1)
            lingkar_perut = st.slider("Lingkar Perut (cm):", min_value=50, max_value=150, value=50, step=1)
            pemeriksaan_gula = st.slider("Hasil Pemeriksaan Gula (mg/dL):", min_value=70, max_value=300, value=70, step=1)
